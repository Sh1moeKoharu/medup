...
export const COUNTRIES: Country[] = [
  ...
  { id: 248, alpha2: 'ax', alpha3: 'ala', name: 'Islas Aland' },
  ...
  { id: 535, alpha2: 'bq', alpha3: 'bes', name: 'Caribe neerlandés' },
  ...
  { id: 203, alpha2: 'cz', alpha3: 'cze', name: 'Chequia' },
  ...
  { id: 748, alpha2: 'sz', alpha3: 'swz', name: 'Esuatini' },
  ...
  { id: 260, alpha2: 'tf', alpha3: 'atf', name: 'Territorios Australes Franceses' },
  ...
  { id: 336, alpha2: 'va', alpha3: 'vat', name: 'Ciudad del Vaticano' },
  { id: 340, alpha2: 'hn', alpha3: 'hnd', name: 'Honduras' },
  { id: 344, alpha2: 'hk', alpha3: 'hkg', name: 'RAE de Hong Kong (China)' },
  ...
  { id: 446, alpha2: 'mo', alpha3: 'mac', name: 'RAE de Macao (China)' },
  ...
  { id: 104, alpha2: 'mm', alpha3: 'mmr', name: 'Myanmar (Birmania)' },
  ...
  { id: 275, alpha2: 'ps', alpha3: 'pse', name: 'Territorios Palestinos' },
  ...
  { id: 642, alpha2: 'ro', alpha3: 'rou', name: 'Rumanía' },
  ...
  { id: 654, alpha2: 'sh', alpha3: 'shn', name: 'Santa Elena' },
  ...
  { id: 682, alpha2: 'sa', alpha3: 'sau', name: 'Arabia Saudí' },
  ...
  { id: 239, alpha2: 'gs', alpha3: 'sgs', name: 'Islas Georgia del Sur y Sandwich del Sur' },
  ...
  { id: 158, alpha2: 'tw', alpha3: 'twn', name: 'Taiwán' },
  ...
  { id: 581, alpha2: 'um', alpha3: 'umi', name: 'Islas menores alejadas de EE. UU.' },
  ...
  { id: 850, alpha2: 'vi', alpha3: 'vir', name: 'Islas Vírgenes de EE. UU.' },
  { id: 876, alpha2: 'wf', alpha3: 'wlf', name: 'Wallis y Futuna' },
  { id: 732, alpha2: 'eh', alpha3: 'esh', name: 'Sáhara Occidental' },
...
/**
 * Nombre del país, para enseñarlo.
 *
 * ── POR QUÉ YA NO LLAMA A `Intl.DisplayNames` ───────────────────────────────
 * Antes traducía en ejecución, a partir del código ISO. En web funcionaba, pero
 * en React Native `Intl.DisplayNames` depende de la build de Hermes que le
 * toque al dispositivo, y donde no está, las 249 entradas caían al inglés sin
 * dar ningún error: la misma tableta enseñaba «Germany» o «Alemania» según con
 * qué se hubiera compilado.
 *
 * Ahora los nombres están escritos arriba, en español. Los puso el mismo ICU,
 * pero una sola vez y fuera del dispositivo. Lo que se ejecuta aquí ya no
 * traduce: sólo lee, y da igual el motor.
 *
 * Se conserva la función y no se lee `country.name` en el sitio de uso para que
 * siga habiendo UN punto por donde pasan todos los nombres, que es lo que
 * permitió cambiar esto sin tocar las pantallas.
 */
export const getCountryName = (country: Country): string => country.name;
