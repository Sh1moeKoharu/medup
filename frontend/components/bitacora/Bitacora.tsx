...
export function describir(asiento: AsientoBitacora): string {
  ...
  const reglas: [RegExp, string][] = [
    ...
    [/^\/admin\/draft-orders\/[^/]+\/aseguranza$/, 'Eligió la aseguranza de un cobro'],
    ...
    [/^\/admin\/insurances/, 'Modificó una aseguranza'],
    [/^\/admin\/medical-customers/, 'Consultó un expediente clínico'],
    [/^\/admin\/patient-insurances/, 'Marcó las aseguranzas de un paciente'],
