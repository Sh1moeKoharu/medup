  ...
  return (
    ...
    >
      <View className="w-full max-w-sm items-center">
        ...
        <Text className="mt-2 text-center text-gray-200">
        ...
        <View className="mt-8 w-full rounded-2xl bg-white p-6">
          ...
          <Text className="mb-4 text-lg">{state.user.name || aUsuario(state.userEmail)}</Text>
          ...
          <TextInput
            ...
            autoFocus
            returnKeyType="go"
            className="w-full rounded-xl border border-gray-300 bg-white px-4 py-4 text-base"
          />
        ...
        <Text className="mt-2 text-center text-xs text-gray-200">
