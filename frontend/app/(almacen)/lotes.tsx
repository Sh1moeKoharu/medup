import { Lote, useBajaDeLoteConTipo, useDestruirLote, useLotes } from '@/api/hooks/almacen';
import { useAlmacenes } from '@/api/hooks/requisiciones';
import { CampoConEtiqueta, Chip, Chips, Distintivo, ETIQUETA_LOTE, Seccion, SelectorDeAlmacen, nombreDeAlmacen, soloFecha, useAlmacenInicial } from '@/components/almacen/base';
