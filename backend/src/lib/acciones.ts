...
function reglas(method: string): Regla[] {
  return [
    ...
    [/^\/admin\/draft-orders\/[^/]+\/aseguranza$/, "Eligió la aseguranza de un cobro", "venta"],
    ...
    [/^\/admin\/insurances/, "Modificó una aseguranza", "otra"],
    [/^\/admin\/medical-customers/, "Actualizó un expediente clínico", "paciente"],
    [/^\/admin\/patient-insurances/, "Marcó las aseguranzas de un paciente", "paciente"],
